 ...
 *
 */
public class WxmpSubscribeEventHandler extends WxmpEventMsgTypeHandler {

	public WxmpSubscribeEventHandler() {
	...
	public String handle(String requestBody, Integer orgid) {
		...
		if (StringUtils.isBlank(eventKey)) {
			...
			return buildReplyMsg(toUserName, fromUserName, "欢迎关注成都免费避孕药具公众号");
		}
