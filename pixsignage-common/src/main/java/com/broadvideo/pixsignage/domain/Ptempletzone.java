...
public class Ptempletzone {
	public final static int Type_TEXT = 0;
	public final static int Type_IMAGE = 1;
	public final static int Type_VIDEO = 2;
	public final static int Type_CALENDAR_LIST = 10;
	public final static int Type_CALENDAR_TABLE = 11;
	public final static int Type_CALENDAR_SIGNIN = 12;

	private Integer ptempletzoneid;
	...
	public Integer getPtempletzoneid() {
		return ptempletzoneid;
	}

	public void setPtempletzoneid(Integer ptempletzoneid) {
		this.ptempletzoneid = ptempletzoneid;
	}
