...
public class Dailyflowlog {
	private Integer dailyflowlogid;
	...
	public Integer getDailyflowlogid() {
		return dailyflowlogid;
	}

	public void setDailyflowlogid(Integer dailyflowlogid) {
		this.dailyflowlogid = dailyflowlogid;
	}
	...
	public void setFlowdate(String flowdate) {
		this.flowdate = flowdate == null ? null : flowdate.trim();
	}
