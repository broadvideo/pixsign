...
public interface StaffMapper {
    ...
    int selectCount(@Param(value="subsystem") String subsystem, 
    		@Param(value="vspid") String vspid, @Param(value="orgid") String orgid, @Param(value="search") String search);
    List<Staff> selectList(@Param(value="subsystem") String subsystem, 
    		@Param(value="vspid") String vspid, @Param(value="orgid") String orgid, @Param(value="search") String search, 
    		@Param(value="start") String start, @Param(value="length") String length);
    List<Staff> selectByLoginname(@Param(value="loginname") String loginname, @Param(value="subsystem") String subsystem, 
    ...
    int assignStaffPrivileges(@Param(value="staff")Staff staff, @Param(value="privileges")List<Privilege> privileges);
