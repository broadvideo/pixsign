var myurls = {
	'common.list' : 'rss!list.action',
	'common.add' : 'rss!add.action',
	'common.update' : 'rss!update.action',
	'common.delete' : 'rss!delete.action',
};
...
function initMyEditModal() {
	...
	FormValidateOption.rules['rss.name'] = {};
	FormValidateOption.rules['rss.name']['required'] = true;
	FormValidateOption.rules['rss.url'] = {};
	FormValidateOption.rules['rss.url']['required'] = true;
