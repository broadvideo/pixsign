...
$('#MyTable').dataTable({
	...
	'aoColumns' : [ {'sTitle' : common.view.name, 'mData' : 'name', 'bSortable' : false, 'sWidth' : '10%' }, 
					{'sTitle' : common.view.detail, 'mData' : 'devicegroupid', 'bSortable' : false, 'sWidth' : '15%' },
					{'sTitle' : common.view.bundleschedule, 'mData' : 'devicegroupid', 'bSortable' : false, 'sWidth' : '65%' }, 
...
$('body').on('click', '.pix-bundleschedule', function(event) {
	...
	currentBundleschedules = currentDevicegroup.bundleschedules;
