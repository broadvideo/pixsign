var myurls = {
	'debugreport.list' : 'debugreport!list.action',
	'debugreport.collect' : 'debugreport!collect.action',
};
...
function initMyTable() {
	$('#MyTable').dataTable({
		...
		'bProcessing' : true,
		'bServerSide' : true,
		'sAjaxSource' : myurls['debugreport.list'],
	...
	$('[type=submit]', $('#DebugModal')).on('click', function(event) {
		$.ajax({
			type : 'GET',
			url : myurls['debugreport.collect'],
			data : {
