var myurls = {
	'common.list' : 'livesource!list.action',
	'common.add' : 'livesource!add.action',
	'common.update' : 'livesource!update.action',
	'common.delete' : 'livesource!delete.action',
};
...
function initMyTable() {
	var oTable = $('#MyTable').dataTable({
		...
		'aoColumns' : [ {"sTitle" : "名称", "mData" : "name", "bSortable" : false }, 
						...
						{"sTitle" : "操作", "mData" : "livesourceid", "bSortable" : false }],
		'iDisplayLength' : 10,
...
function initMyEditModal() {
	...
	FormValidateOption.rules['livesource.name'] = {};
	FormValidateOption.rules['livesource.name']['required'] = true;
	FormValidateOption.rules['livesource.uri'] = {};
	FormValidateOption.rules['livesource.uri']['required'] = true;
	...
	$('body').on('click', '.pix-update', function(event) {
		...
		for (var name in data) {
			formdata['livesource.' + name] = data[name];
		}
		refreshForm('MyEditForm');
