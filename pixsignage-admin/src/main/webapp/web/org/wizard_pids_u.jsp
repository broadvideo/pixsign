						...
						<div class="portlet-body">
							<div class="portlet-tabs">
								<ul class="nav nav-tabs">
									...
									<li id="nav_tab4" class="advertflag"><a href="#portlet_tab4" data-toggle="tab">广告</a></li>
									<li id="nav_tab3" class="movieflag"><a href="#portlet_tab3" data-toggle="tab">影片</a></li>
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="portlet_tab3">
										<table id="RegionDtlMovieTable" class="table table-condensed table-hover">
											<thead></thead>
											<tbody></tbody>
										</table>
									</div>
									<div class="tab-pane" id="portlet_tab4">
										<table id="RegionDtlAdvertTable" class="table table-condensed table-hover">
											<thead></thead>
											<tbody></tbody>
										</table>
									</div>
...
<script src="../local/scripts/pix-wizard-pids-u.js?t=0"></script>
