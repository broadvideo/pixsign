<%@page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<script type="text/javascript" src="../assets/plugins/jquery-loadJSON/jquery.loadJSON.js"></script>
	<script type="text/javascript" src="../assets/plugins/jquery-json/jquery.json-2.4.js"></script>
