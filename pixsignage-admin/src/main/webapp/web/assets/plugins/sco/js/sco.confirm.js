...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			$modal = $('<div class="modal" id="' + this.options.target.substr(1) + '"><div class="modal-dialog"><div class="modal-content"><div class="modal-body inner"/><div class="modal-footer"><a href="#" class="btn btn-danger" data-action="1">确定</a><a class="btn cancel" href="#" data-dismiss="modal">取消</a></div></div></div></div>').appendTo(this.options.appendTo).hide();
