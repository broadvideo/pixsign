...
function initTab4() {
	...
	jQuery('#DeviceTable_wrapper .dataTables_filter input').addClass("form-control input-small"); // modify table search input
...
function initData5() {
	$('#ScheduleForm input[name="task.type"][value="1"]').attr("checked", true);
	$('#ScheduleForm input[name="task.type"][value="1"]').parent().addClass("checked");
	$('#ScheduleForm input[name="task.type"][value="2"]').attr("checked", false);
