				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="tools">
								<a href="javascript:;" onClick="DebugreportModule.refresh();" class="reload"></a>
							</div>
						</div>
						<div class="portlet-body">
							...
							<table id="DebugreportTable" class="table table-striped table-bordered table-hover">
								<thead></thead>
								<tbody></tbody>
							</table>
						</div>
...
<script src="${base_ctx}/scripts/sys/debugreport.js?t=${timestamp}"></script>
<script>
