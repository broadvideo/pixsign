	...
	<div class="row main-content">
		...
		<div class="row content-bar">
			<div class="pull-right">
				<button class="btn blue pix-add"><spring:message code="global.upload"/> <i class="fa fa-plus"></i></button>
			</div>
		</div>
...
<script src="${base_ctx}/youwang/scripts/image.js?t=${timestamp}"></script>
