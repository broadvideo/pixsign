						...
						<div class="modal-body">
							<form id="OrgEditForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
								...
								<div class="form-body">
									...
									<div class="form-group diy-ctrl">
										<label class="col-md-3 control-label"><spring:message code="pixsign.org.diyflag"/><span class="required">*</span></label>
										<div class="col-md-9 radio-list">
											<label class="radio-inline">
												<input type="radio" name="org.diyflag" value="0" checked> <spring:message code="global.off"/>
											</label>
											<label class="radio-inline">
												<input type="radio" name="org.diyflag" value="1"> <spring:message code="global.on"/>
											</label>
										</div>
									</div>
