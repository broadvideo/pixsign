...
<body>
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<h3 class="page-title"><spring:message code="menu.wxinfo"/></h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="#"><spring:message code="menu.wxinfo"/></a>
					</li>
				</ul>
			</div>
...
<script src="${base_ctx}/scripts/pix-wxinfo.js?t=${timestamp}"></script>
<script>
