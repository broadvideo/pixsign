...
<head>
<link href="${static_ctx}/admin/pages/css/timeline.css" rel="stylesheet" type="text/css"/>
...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><spring:message code="global.pagepkg"/></h4>
				</div>
				<div class="modal-body">
					<form id="MyEditForm" class="form-horizontal" method="POST">
						<input type="hidden" name="pagepkg.pagepkgid" value="0" />
						<input type="hidden" name="pagepkg.status" value="1" />
						<div class="form-body">
							<div class="form-group">
								<label class="col-md-3 control-label"><spring:message code="global.name"/><span class="required">*</span></label>
								<div class="col-md-9">
									<div class="input-icon right">
										<i class="fa"></i> <input type="text" class="form-control" name="pagepkg.name" />
									</div>
								</div>
							</div>
							<div class="form-group hide-update">
								<label class="col-md-3 control-label"><spring:message code="global.template"/><span class="required">*</span></label>
								<div class="col-md-9">
									<input type="hidden" id="TemplateSelect1" class="form-control select2" name="pagepkg.templateid">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label"><spring:message code="global.description"/></label>
								<div class="col-md-9">
									<textarea class="form-control" rows="4" name="pagepkg.description"></textarea>
								</div>
							</div>
						</div>
					</form>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="PageEditForm" class="form-horizontal" data-async data-target="#PageEditModal" method="POST">
						...
						<input type="hidden" name="page.type" value="0" />
						<input type="hidden" name="page.entry" value="0" />
						<div class="form-body">
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-md-3 control-label"><spring:message code="global.template"/><span class="required">*</span></label>
								<div class="col-md-9">
									<input type="hidden" id="TemplateSelect2" class="form-control select2" name="page.templateid">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label"><spring:message code="global.description"/></label>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<h3 class="page-title"><spring:message code="menu.pagepkg"/></h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="#"><spring:message code="menu.pagepkg"/></a>
					</li>
				</ul>
			</div>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-desktop"></i><spring:message code="global.pagepkg"/></div>
							<div class="tools">
								<a href="javascript:;" onClick="$('#MyTable').dataTable()._fnAjaxUpdate();" class="reload"></a>
							</div>
						</div>
						<div class="portlet-body page-container-bg-solid">
							...
							<table id="MyTable" class="table table-striped table-bordered table-hover" style="background-color:#F1F3FA;">
								<thead></thead>
								<tbody></tbody>
							</table>
						</div>
...
<script src="${base_ctx}/scripts/pix-pagepkg.js?t=${timestamp}"></script>
<script>
