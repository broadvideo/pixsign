...
<!--
   <div name="container"  style="position:relative;line-height:20px;color:#fff;font-size:.85em;width:100%;height:80px;padding-top:20px;text-align:center;background-color:green;opacity:0.7">
	   <span name="scheduleOpt" style="position:absolute;top:0px;left:0px;display:none;"><input type="checkbox" name="courseschedule.coursescheduleid" value="{$T.coursescheduleid}" style="margin:0px;width:16px;height:16px;" /></span>
...
<table class="table table-striped2  table-bordered" id="scheduleTableList">
	...
	<tbody>
	  ...
	  {#foreach $T.morningperiodtimedtls as record}
		   ...
		   {#else}
			  <tr height="80px;" data-period="{$T.index}" data-id="{$T.record.periodtimedtlid}">
			   <td>{$T.record.periodnum}</td>
			   <td class="editable" data-workday="1"></td>
			   <td class="editable" data-workday="2"></td>
			   <td class="editable" data-workday="3"></td>
              ...
              <div class="row">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="hidden" name="courseschedule.classroomid" value="{$T.classroomid}" />
                     ...
                     <input type="hidden" name="courseschedule.periodtimedtlid" value="{$T.periodtimedtlid}"/>
                     <input type="hidden" name="courseschedule.coursescheduleschemeid" value="{$T.coursescheduleschemeid}"/>
                     <input type="hidden" name="courseschedule.coursescheduleid" value="{$T.scheduleid}"/>
                      <input type="text" class="form-control" name="courseschedule.coursename" value="{$T.coursename}" />
                    </div>
                  </div>
                  <div class="form-group row">
...
<script src="${base_ctx}/scripts/pix-courseschedule.js?t=${timestamp}"></script>
<script>
