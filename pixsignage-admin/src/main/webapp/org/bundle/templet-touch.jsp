		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><spring:message code="pixsign.touchtemplet"/></h4>
				</div>
	...
	<div id="SubtempletModal" class="modal fade modal-scroll" tabindex="-1" role="dialog" data-backdrop="static">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><spring:message code="pixsign.subtemplet"/></h4>
				</div>
				<div class="modal-body">
													...
													<div class="col-md-12 col-sm-12">
														<div class="portlet box purple">
															<div class="portlet-title">
																<div class="caption"><i class="fa fa-calendar"></i><spring:message code="pixsign.touchtemplet"/></div>
																<div class="actions">
																	<!-- 
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-cloud"></i><spring:message code="pixsign.touchtemplet"/></div>
							<div class="tools">
...
<script src="${base_ctx}/scripts/org/other/pix-templet-touch.js?t=${timestamp}"></script>
<script src="${base_ctx}/scripts/org/other/pix-templet-wizard.js?t=${timestamp}"></script>
<script src="${base_ctx}/scripts/org/other/pix-preview.js?t=${timestamp}"></script>
<script src="${base_ctx}/scripts/org/other/pix-templet-design1.js?t=${timestamp}"></script>
<script src="${base_ctx}/scripts/org/other/pix-templet-design2.js?t=${timestamp}"></script>
<script>
