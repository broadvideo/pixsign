...
<body>
	<div id="BundleEditModal" class="modal fade modal-scroll" tabindex="-1" role="dialog" data-backdrop="static">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><spring:message code="pixsign.touchbundle"/></h4>
				</div>
				<div class="modal-body">
					<form id="BundleEditForm" class="form-horizontal" data-async data-target="#BundleEditModal" method="POST">
						...
						<input type="hidden" name="bundle.branchid" value="0" />
						<div class="form-body">
							...
							<div class="form-group hide-update">
								<label class="col-md-3 control-label"><spring:message code="pixsign.prop.templetflag"/></label>
	...
	<div id="SubbundleModal" class="modal fade modal-scroll" tabindex="-1" role="dialog" data-backdrop="static">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><spring:message code="pixsign.subbundle"/></h4>
				</div>
				<div class="modal-body">
					<form id="SubbundleForm" class="form-horizontal" data-async data-target="#SubbundleModal" method="POST">
						...
						<div class="form-body">
							...
							<div class="form-group hide-update">
								<label class="col-md-3 control-label"><spring:message code="pixsign.subtemplet"/></label>
								<div class="col-md-9 pre-scrollable">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="note note-success">
						<p><spring:message code="pixsign.tips_2"/></p>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-cloud"></i><spring:message code="pixsign.touchbundle"/></div>
							<div class="tools">
								<a href="javascript:;" onClick="BundleModule.refresh();" class="reload"></a>
							</div>
						</div>
						<div class="portlet-body" id="BundlePortlet">
							<div class="row">
								<div class="col-md-2">
									<div class="row"><div class="col-md-12 branchtree"></div></div>
								</div>
...
<script src="${base_ctx}/scripts/org/bundle/bundle-touch.js?t=${timestamp}"></script>
