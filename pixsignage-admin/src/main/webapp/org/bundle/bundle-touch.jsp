													...
													<div class="col-md-12 col-sm-12">
														<div class="portlet box purple">
															<div class="portlet-title">
																<div class="caption"><i class="fa fa-calendar"></i><spring:message code="pixsign.touchbundle"/></div>
																<div class="actions">
																	<!-- 
														...
														<form id="BundledtlEditForm" class="form-horizontal pix-bordered">
															...
															<div class="form-body">
																...
																<div class="form-group bundle-ctl regiontype-1 objtype-2 public-0">
																	<label class="col-md-3 control-label"><spring:message code="pixsign.text"/></label>
																	<div class="col-md-9">
...
<script src="${base_ctx}/scripts/org/other/pix-bundle-touch.js?t=${timestamp}"></script>
<script src="${base_ctx}/scripts/org/other/pix-bundle-wizard.js?t=${timestamp}"></script>
