			...
			<div class="page-content">
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title"><spring:message code="global.intvideo"/></h4>
							</div>
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><a href="#"><spring:message code="menu.intvideo"/></a>
						</li>
					</ul>
				</div>
				<!-- END PAGE HEADER-->
					...
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="fa fa-video-camera"></i><spring:message code="global.intvideo"/></div>
								<div class="tools">
...
<script src="${base_ctx}/scripts/pix-video.js?t=7"></script>
<script>
//上传文件的后缀
