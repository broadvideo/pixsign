...
<body>
	<div class="page-content-wrapper">
		<div class="page-content">
				...
				<div class="modal-dialog modal-wide">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title"><spring:message code="menu.smartbox"/></h4>
						</div>
						<div class="modal-body">
							<form id="MyEditForm" class="form-horizontal" method="POST">
								<input type="hidden" name="smartbox.smartboxid" value="0" />
								<div class="form-body">
									   <div class="form-group">
											<label class="col-md-3 control-label">绑定终端</label>
											<div class="col-md-9">
												 <input type="hidden" id="ClassSelect" class="form-control select2" name="smartbox.terminalid">
											</div>
									    </div>
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<div class="input-icon right">
													<i class="fa"></i> <input type="text" class="form-control" name="smartbox.name" />
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-9">
												<div class="input-icon right">
													<textarea class="form-control" rows="3" name="smartbox.description"></textarea> 
												</div>
											</div>
										</div>
									   <div class="form-group">
											<label class="col-md-3 control-label">库存数<span class="required">*</span></label>
											<div  class="col-md-9">
											   <div class="input-icon right">
													<i class="fa"></i> <input type="text" class="form-control" name="smartbox.stocknum" />
												</div>
											</div>
										</div>
								</div>
			...
			<h3 class="page-title"><spring:message code="menu.smartbox"/></h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li><i class="fa fa-home"></i><a href="../../<%=mainpage%>">Home</a><i
							class="fa fa-angle-right"></i>
					</li>
					<li><a href="#"><spring:message code="menu.smartboxmanage"/></a><i class="fa fa-angle-right"></i>
					</li>
					<li><a href="#"><spring:message code="menu.smartbox"/></a>
					</li>
				</ul>
			</div>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-cogs"></i><spring:message code="menu.smartbox"/></div>
							<div class="tools">
...
<script src="${base_ctx}/scripts/org/smartbox/smartbox.js?t=${timestamp}"></script>
<script>
...
jQuery(document).ready(function() {
	...
	var smartboxModule=new SmartboxModule();
	smartboxModule.init();
});
