...
<%@ include file="/common/common2.jsp"%>
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<div id="VchannelScheduleModal" class="modal fade modal-scroll" tabindex="-1" role="dialog" data-backdrop="static">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<div class="input-icon right">
													<i class="fa"></i> <input type="text" class="form-control" name="vchannel.name" placeholder="请输入频道名称" />
												</div>
											</div>
										</div>
										<div class="form-group">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="fa fa-desktop"></i>轮播频道</div>
								<div class="tools">
...
<script src="${base_ctx}/scripts/pix-vchannel.js?t=2"></script>
<script>
