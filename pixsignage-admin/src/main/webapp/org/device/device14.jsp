		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-desktop"></i>芯华测温</div>
							<div class="tools">
...
<script src="${base_ctx}/scripts/org/device/device-14.js?t=${timestamp}"></script>
<script>
