...
<body>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<h3 class="page-title"><spring:message code="menu.3dfanwall"/></h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="#"><spring:message code="menu.3dfanwall"/></a>
					</li>
				</ul>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="portlet box blue tabbable">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-desktop"></i><spring:message code="pixsign.3dfanwall"/></div>
							<div class="tools">
...
<script src="${base_ctx}/scripts/org/device/3dfanwall.js?t=${timestamp}"></script>
<script>
