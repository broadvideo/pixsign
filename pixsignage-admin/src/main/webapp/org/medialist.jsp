			...
			<div class="page-content">
									...
									<div class="portlet-title">
										...
										<ul class="nav nav-tabs">
											<li id="nav_tab3" class="imageflag">
												<a href="#portlet_tab3" data-toggle="tab">图片</a>
											</li>
											<li id="nav_tab2" class="videoflag">
												<a href="#portlet_tab2" data-toggle="tab">引入视频</a>
											</li>
											<li id="nav_tab1" class="videoflag active">
												<a href="#portlet_tab1" data-toggle="tab">本地视频</a>
											</li>
										</ul>
									</div>
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<div class="input-icon right">
													<i class="fa"></i> <input type="text" class="form-control" name="medialist.name" placeholder="请输入媒体列表名称" />
												</div>
											</div>
										</div>
										<div class="form-group">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="fa fa-desktop"></i>媒体列表</div>
								<div class="tools">
...
<script src="${base_ctx}/scripts/pix-medialist.js?t=2"></script>
<script>
