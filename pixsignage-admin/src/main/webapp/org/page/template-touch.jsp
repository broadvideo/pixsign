...
<body>
	...
	<div id="SubtemplateModal" class="modal fade modal-scroll" tabindex="-1" role="dialog" data-backdrop="static">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><spring:message code="pixsign.subtemplate"/></h4>
				</div>
				<div class="modal-body">
					<form id="SubtemplateForm" class="form-horizontal" data-async data-target="#SubtemplateModal" method="POST">
						<input type="hidden" name="template.templateid" value="0" />
						<input type="hidden" name="template.hometemplateid" value="0" />
						<input type="hidden" name="template.touchflag" value="1" />
						<input type="hidden" name="template.homeflag" value="0" />
						<input type="hidden" name="template.status" value="1" />
						<input type="hidden" name="template.ratio" value="1" />
						<div class="form-body">
							<div class="form-group">
							...
							<div class="form-group">
							 ...
							 -->
							<div class="form-group hide-update">
								<label class="col-md-3 control-label"><spring:message code="pixsign.subtemplate"/></label>
								<div class="col-md-9 pre-scrollable">
									<table id="FromTemplateTable">
									</table>
								</div>
							</div>
						</div>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="#"><spring:message code="menu.touchtemplate"/></a>
					</li>
				</ul>
			</div>
