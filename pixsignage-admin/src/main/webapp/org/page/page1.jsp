			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="MyEditForm" class="form-horizontal" data-async data-target="#MyEditModal" method="POST">
						...
						<input type="hidden" name="page.templateflag" value="0" />
						...
						<div class="form-body">
							...
							<div class="form-group hide-update">
								...
								<div class="col-md-9">
									<input type="hidden" id="TemplateSelect" class="form-control select2" name="page.templateid">
								</div>
							</div>
							<div class="form-group">
...
<script src="${base_ctx}/scripts/org/other/pix-page1.js?t=${timestamp}"></script>
