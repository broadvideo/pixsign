							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<div class="input-icon right">
										<i class="fa"></i> <input type="text" class="form-control" name="media.name" placeholder="请输入视频名称" />
									</div>
								</div>
							</div>
						</div>
		...
		<div class="col-md-12">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-video-camera"></i>视频</div>
					<div class="tools">
				...
				<div class="portlet-body">
					<div class="table-toolbar">
						...
						<div class="btn-group">
						<%
							if (org.getCurrentstorage() >= org.getMaxstorage() && !org.getUploadflag().equals("2")) {
						%>
							<button privilegeid="201010" class="btn green pix-full">在线上传 <i class="fa fa-plus"></i></button>
						<%
							} else if (!org.getUploadflag().equals("2")) {
						%>
						...
						<div class="btn-group">
						<%
							if (org.getCurrentstorage() >= org.getMaxstorage() && !org.getUploadflag().equals("1")) {
						%>
							<button privilegeid="201010" class="btn green pix-full">PixTrans上传 <i class="fa fa-plus"></i></button>
						<%
							} else if (!org.getUploadflag().equals("1")) {
						%>
							<a privilegeid="201010" class="btn green" href="ptup:sessid=">PixTrans上传 <i class="fa fa-plus"></i></a>
						<%
							}
						%>
						</div>
...
<script src="../local/scripts/pix-upload.js?t=1"></script>
<script>
//上传文件的后缀
