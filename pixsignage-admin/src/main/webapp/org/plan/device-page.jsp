															...
															<div class="portlet-title">
																...
																<ul class="nav nav-tabs">
																	<li id="nav_dtab1" class="active">
																		<a href="#BindTab1" data-toggle="tab"><spring:message code="pixsign.device"/></a>
																	</li>
																	<li id="nav_dtab2">
																		<a href="#BindTab2" data-toggle="tab"><spring:message code="pixsign.devicegroup"/></a>
																	</li>
																</ul>
															</div>
															<div class="portlet-body">
																<div class="tab-content">
																	<div class="tab-pane active" id="BindTab1">
																		<div class="row">
																			<div class="col-md-3">
																				<div class="row"><div class="col-md-12 branchtree"></div></div>
																			</div>
																			<div class="col-md-9">
																				<table id="BindTable1" class="table table-condensed table-hover">
																					<thead></thead>
																					<tbody></tbody>
																				</table>
																			</div>
																	...
																	<div class="tab-pane" id="BindTab2">
																		<div class="row">
																			<div class="col-md-3">
																				<div class="row"><div class="col-md-12 branchtree"></div></div>
																			</div>
																			<div class="col-md-9">
																				<table id="BindTable2" class="table table-condensed table-hover">
																					<thead></thead>
																					<tbody></tbody>
																				</table>
																			</div>
...
<script src="${base_ctx}/scripts/common/bind-select.js?t=${timestamp}"></script>
