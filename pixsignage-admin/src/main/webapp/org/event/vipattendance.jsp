	...
	<div class="page-content-wrapper">
		<div class="page-content">
				...
				<div class="modal-dialog modal-wide">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title"><spring:message code="menu.vipattendance"/></h4>
						</div>
		  ...
		  <div id="MeetingSearchModal" class="modal fade modal-scroll" tabindex="-1" role="dialog" data-backdrop="static">
			...
			<h3 class="page-title"><spring:message code="menu.vipattendance"/></h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="#"><spring:message code="menu.vipattendance"/></a>
					</li>
				</ul>
			</div>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-cogs"></i><spring:message code="menu.vipattendance"/></div>
							<div class="tools">
...
<script src="${base_ctx}/scripts/org/event/vipattendance.js?t=${timestamp}"></script>
<script>
