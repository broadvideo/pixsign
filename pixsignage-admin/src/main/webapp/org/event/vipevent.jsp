		...
		<div class="page-content">
				...
				<div class="modal-dialog modal-wide modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title"><spring:message code="menu.vipevent"/></h4>
						</div>
							...
							<form id="MyEditForm" class="form-horizontal" method="POST"  >
								...
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">VIP室<span class="required">*</span></label>
										<div class="col-md-9">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="#"><spring:message code="menu.vipevent"/></a>
					</li>
				</ul>
			</div>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-video-camera"></i><spring:message code="menu.vipevent"/></div>
							<div class="tools">
...
<script src="${base_ctx}/scripts/org/event/vipevent.js?t=${timestamp}"></script>
<script>
