		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><spring:message code="pixsign.diy"/></h4>
				</div>
				<div class="modal-body">
					<form id="UploadForm" class="form-horizontal" action="diy!upload.action" method="POST" enctype="multipart/form-data">
						...
						<div class="row fileupload-buttonbar">
							<div class="col-lg-6">
								...
								<span><spring:message code="pixsign.diy"/></span>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="#"><spring:message code="menu.diy"/></a>
					</li>
				</ul>
			</div>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-video-camera"></i><spring:message code="pixsign.diy"/></div>
							<div class="tools">
								<a href="javascript:;" onClick="DiyModule.refresh();" class="reload"></a>
							</div>
						</div>
						<div class="portlet-body" id="DiyPortlet">
							<div class="row">
								<div class="col-md-2">
								...
								<div class="col-md-10">
									...
									<table id="DiyTable" class="table table-striped table-bordered table-hover">
										<thead></thead>
										<tbody></tbody>
									</table>
								</div>
	...
	<tr class="template-upload fade">
		<td>
			<div class="input-icon right">
				<i class="fa"></i>
				<input type="hidden" name="branchids" value="{%=DiyTree.branchid%}" />
			</div>
		</td>
		<td>
...
<script src="${base_ctx}/scripts/org/resource/diy.js?t=${timestamp}"></script>
<script>
