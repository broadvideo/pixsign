...
<body>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="UploadForm" class="form-horizontal" action="audio!upload.action" method="POST" enctype="multipart/form-data">
	...
	<div id="AudioEditModal" class="modal fade modal-scroll" tabindex="-1" role="dialog" data-backdrop="static">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="AudioEditForm" class="form-horizontal" method="POST">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<h3 class="page-title"><spring:message code="menu.audio"/></h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="#"><spring:message code="menu.audio"/></a>
					</li>
				</ul>
			</div>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="tools">
								<a href="javascript:;" onClick="AudioModule.refresh();" class="reload"></a>
							</div>
						</div>
						<div class="portlet-body" id="AudioPortlet">
							<div class="row">
								<div class="col-md-2">
								...
								<div class="col-md-10">
									...
									<table id="AudioTable" class="table table-striped table-bordered table-hover">
										<thead></thead>
										<tbody></tbody>
									</table>
								</div>
	...
	<tr class="template-upload fade">
		<td>
			<div class="input-icon right">
				...
				<input type="hidden" name="branchids" value="{%=AudioTree.branchid%}" />
			</div>
		</td>
		<td>
...
<script src="${base_ctx}/scripts/org/resource/audio.js?t=${timestamp}"></script>
<script>
