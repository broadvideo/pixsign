...
<body>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="UploadForm" class="form-horizontal" action="house!upload.action" method="POST" enctype="multipart/form-data">
	...
	<div id="HouseEditModal" class="modal fade modal-scroll" tabindex="-1" role="dialog" data-backdrop="static">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="HouseEditForm" class="form-horizontal" method="POST">
						<input type="hidden" name="house.houseid" value="0" />
						<input type="hidden" name="house.folderid" value="0" />
						<div class="form-body">
							<div class="form-group">
								<label class="col-md-3 control-label"><spring:message code="pixsign.prop.name"/><span class="required">*</span></label>
								<div class="col-md-9">
									<div class="input-icon right">
										<i class="fa"></i> <input type="text" class="form-control" name="house.name" />
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-video-camera"></i>楼盘</div>
							<div class="tools">
								<a href="javascript:;" onClick="HouseModule.refresh();" class="reload"></a>
							</div>
						</div>
						<div class="portlet-body" id="HousePortlet">
...
<script src="${base_ctx}/scripts/org/resource/house.js?t=${timestamp}"></script>
<script>
