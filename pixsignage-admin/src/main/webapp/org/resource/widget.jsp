...
<body>
	<div id="WidgetEditModal" class="modal fade modal-scroll" tabindex="-1" role="dialog" data-backdrop="static">
		<div class="modal-dialog modal-wide">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="WidgetEditForm" class="form-horizontal" method="POST">
						...
						<div class="portlet-body" id="WidgetPortlet">
							<div class="row">
								...
								<div class="col-md-10">
									...
									<table id="WidgetTable" class="table table-striped table-bordered table-hover">
										<thead></thead>
										<tbody></tbody>
									</table>
								</div>
...
<script src="${base_ctx}/scripts/org/resource/widget.js?t=${timestamp}"></script>
<script>
