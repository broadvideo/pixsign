...
<body>
	<div id="DVBEditModal" class="modal fade modal-scroll" tabindex="-1" role="dialog" data-backdrop="static">
		<div class="modal-dialog modal-wide">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="DVBEditForm" class="form-horizontal" method="POST">
						<input type="hidden" name="dvb.dvbid" value="0" />
						<input type="hidden" name="dvb.branchid" value="0" />
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="#"><spring:message code="menu.dvb"/></a>
					</li>
				</ul>
			</div>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="tools">
								<a href="javascript:;" onClick="DVBModule.refresh();" class="reload"></a>
							</div>
						</div>
						<div class="portlet-body" id="DVBPortlet">
							<div class="row">
								<div class="col-md-2">
								...
								<div class="col-md-10">
									...
									<table id="DVBTable" class="table table-striped table-bordered table-hover">
										<thead></thead>
										<tbody></tbody>
									</table>
								</div>
...
<script src="${base_ctx}/scripts/org/resource/dvb.js?t=${timestamp}"></script>
<script>
