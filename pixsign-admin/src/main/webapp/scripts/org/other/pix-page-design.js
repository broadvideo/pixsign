...
function refreshPagezone(pagezone) {
	...
	if (pagezone.type == 1) {
		...
		if (pagezone.pagezonedtls.length > 0 && pagezone.pagezonedtls[0].image != null) {
			$(pagezoneDiv).find('img').attr('src', '/pixsigndata' + pagezone.pagezonedtls[0].image.filepath);
			$(pagezoneDiv).find('img').attr('width', '100%');
			$(pagezoneDiv).find('img').attr('height', '100%');
		}
	} else if (pagezone.type == 3) {
		...
		if (pagezone.pagezonedtls.length > 0 && pagezone.pagezonedtls[0].image != null) {
			$(pagezoneDiv).find('#rotatable').css('background-image', 'url(/pixsigndata' + pagezone.pagezonedtls[0].image.filepath + ')');
...
function displayBGImagePreview() {
	...
	if (CurrentZone.pagezonedtls.length > 0) {
		...
		if (backgroundimage != '') {
			$('#BGImagePreview').css('background-image', 'url(/pixsigndata' + backgroundimage.filepath + ')');
