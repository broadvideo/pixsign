...
function redrawLayout(div, templet, templetdtl) {
	...
	if (templet.bgimage != null) {
		div.append('<img class="templet-bg" src="/pixsigndata' + templet.bgimage.thumbnail + '" width="100%" height="100%" style="right: 0; bottom: 0; position: absolute; top: 0; left: 0; z-index: 0" />');
	}
