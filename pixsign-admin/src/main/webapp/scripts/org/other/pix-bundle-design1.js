...
function redrawLayout(div, bundle, bundledtl) {
	...
	if (bundle.bgimage != null) {
		div.append('<img class="bundle-bg" src="/pixsigndata' + bundle.bgimage.thumbnail + '" width="100%" height="100%" style="right: 0; bottom: 0; position: absolute; top: 0; left: 0; z-index: 0" />');
	}
