...
var oTable = $('#MyTable').dataTable({
	...
	'fnRowCallback': function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
		...
		if (aData.snapshot != null) {
			pagehtml += '<a class="fancybox" href="/pixsigndata' + aData.snapshot + '" title="' + aData.name + '">';
			pagehtml += '<div class="thumbs">';
			var thumbwidth = aData.width > aData.height? 100 : 100*aData.width/aData.height;
			pagehtml += '<img src="/pixsigndata' + aData.snapshot + '" class="imgthumb" width="' + thumbwidth + '%" alt="' + aData.name + '" />';
			pagehtml += '</div></a>';
		} else {
			pagehtml += '<div class="thumbs">';
			pagehtml += '</div>';
