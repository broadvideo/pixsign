var OnlinelogModule = function () {
	...
	var initDetailModal = function () {
		...
		$('#OnlinelogTable').dataTable({
			...
			'aoColumns' : [ {'sTitle' : common.view.device, 'mData' : 'onlinelogid', 'bSortable' : false, 'sWidth' : '40%' },
			                {'sTitle' : common.view.onlinetime, 'mData' : 'onlinetime', 'bSortable' : false, 'sWidth' : '20%' },
							{'sTitle' : common.view.offlinetime, 'mData' : 'offlinetime', 'bSortable' : false, 'sWidth' : '20%' },
