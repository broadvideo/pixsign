	...
	var preview = function (container, page, maxsize) {
		...
		for (var i = 0; i < zones.length; i++) {
			...
			if (zone.type == 1) {
				...
				if (zonedtls.length > 0 && zonedtls[0].image != null) {
					$(inner_div).css('background-image', 'url(/pixsigndata' + zonedtls[0].image.thumbnail + ')');
				...
				$(inner_div).find('span').html('æ·±åœ³  <img src="/pixsignage-page/image/weather/30.png" /> 30â„?');
