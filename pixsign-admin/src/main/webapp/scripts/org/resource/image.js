	...
	var initImageTable = function () {
		...
		$('#ImageTable').dataTable({
			...
			'fnRowCallback': function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
				...
				imagehtml += '<div>';
				imagehtml += '<a class="btn default btn-sm green imagefancybox" href="/pixsigndata' + aData.filepath + '" title="' + aData.name + '"><i class="fa fa-search"></i></a>';
				...
				if (aData.relateimage != null) {
					...
					imagehtml += '<a class="imagefancybox" href="/pixsigndata' + aData.relateimage.filepath + '" title="' + aData.relateimage.name + '">';
					imagehtml += '<div id="RelateThumb" class="thumbs">';
					imagehtml += '<img src="/pixsigndata' + aData.relateimage.thumbnail + '" class="imgthumb" width="100%" alt="' + aData.relateimage.name + '" thumbwidth="' + thumbwidth + '" thumbheight="' + thumbheight + '"/>';
					imagehtml += '</div>';
					imagehtml += '</a>';
				} else if (aData.relatevideo != null) {
					var relatethumbnail = '../../img/video.jpg';
					if (aData.relatevideo.thumbnail != null) {
						relatethumbnail = '/pixsigndata' + aData.relatevideo.thumbnail;
					}
					...
					if (aData.relatevideo.filepath != null && aData.relatevideo.previewflag == 1) {
						...
						var videourl = '/pixsigndata/video/preview/' + aData.relatevideo.videoid + '.mp4';
