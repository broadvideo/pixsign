		...
		$('#VideoTable').dataTable({
			...
			'fnRowCallback': function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
				...
				if (aData.filepath != null && aData.previewflag == 1) {
					...
					var videourl = '/pixsigndata/video/preview/' + aData.videoid + '.mp4';
				...
				if (aData.relateimage != null) {
					...
					videohtml += '<a class="imagefancybox" href="/pixsigndata' + aData.relateimage.filepath + '" title="' + aData.relateimage.name + '">';
					videohtml += '<div id="RelateThumb" class="thumbs">';
					videohtml += '<img src="/pixsigndata' + aData.relateimage.thumbnail + '" class="imgthumb" width="100%" alt="' + aData.relateimage.name + '" thumbwidth="' + thumbwidth + '" thumbheight="' + thumbheight + '"/>';
					videohtml += '</div>';
					videohtml += '</a>';
