				...
				if (data.errorcode == 0) {
					...
					if (BundleCtrl) {
						if (_org.backupvideo != null) {
							...
							if (_org.backupvideo.thumbnail == null) {
								...
								backupvideohtml = '<span><img src="/pixsigndata' + _org.backupvideo.thumbnail + '" height="25" /> ' + _org.backupvideo.name + '</span>';
							}
					...
					if (_org.defaultpage != null) {
						...
						if (_org.defaultpage.snapshot == null) {
							...
							defaultpagehtml = '<span><img src="/pixsigndata' + _org.defaultpage.snapshot + '" height="25" /> ' + _org.defaultpage.name + '</span>';
						}
			...
			$('#BackupMediaSelect').select2({
				...
				formatResult: function (data) {
					if (data.video == null || data.video.thumbnail == null) {
						...
						return '<span><img src="/pixsigndata' + data.video.thumbnail + '" height="25" /> ' + data.text + '</span>';
					}
				},
			...
			$('#DefaultPageSelect').select2({
				...
				formatResult: function (data) {
					if (data.page == null || data.page.snapshot == null) {
						...
						return '<span><img src="/pixsigndata' + data.page.snapshot + '" height="25" /> ' + data.text + '</span>';
					}
				},
				formatSelection: function (data) {
					if (data.page == null || data.page.snapshot == null) {
