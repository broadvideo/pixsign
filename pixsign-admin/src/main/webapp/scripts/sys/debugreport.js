	...
	var initDebugreportTable = function () {
		$('#DebugreportTable').dataTable({
			...
			'fnRowCallback' : function(nRow, aData, iDisplayIndex) {
				...
				$('td:eq(4)', nRow).html('<a href="/pixsigndata' + aData.filepath + '" data-id="' + iDisplayIndex + '" class="btn default btn-xs blue"><i class="fa fa-cloud-download"></i>' + common.view.download + ' </a>');
				return nRow;
			}
		});
